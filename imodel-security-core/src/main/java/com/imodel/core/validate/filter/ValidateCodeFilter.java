package com.imodel.core.validate.filter;

import com.imodel.core.properties.SecurityProperties;
import com.imodel.core.validate.controller.ValidateCodeController;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        String[] configUrls = StringUtils.splitByWholeSeparatorPreserveAllTokens(securityProperties.getValidate().getImage().getUrl(),",");
    ...
    private void validate(ServletWebRequest request) throws ServletRequestBindingException {
        ...
        ImageCode codeInSession = (ImageCode) sessionStrategy.getAttribute(request,
                ValidateCodeProcess.SESSION_KEY_PREFY+"IMAGE");
        ...
        if(codeInSession.isExpried()){
            sessionStrategy.removeAttribute(request, ValidateCodeProcess.SESSION_KEY_PREFY+"IMAGE");
